...
def to_process_if(o: Process | SerializedProcess) -> Process:
    ...
    if isinstance(o, Process):
        return o  # todo: 'copied is better than aliased' vs .to_process_if
...
def main_try() -> None:
    ...
    if main_args.c:
        raise NotImplementedError(f"-c {main_args.c!r}")

        # dash_c_text = main_args.c
        # csp_lines = dash_c_text.split(";")
